...
public class FormRelatorioNotaEntrada extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioNotaEntrada frame = new FormRelatorioNotaEntrada();
	 ...
	 * Create the frame.
	 */
	public FormRelatorioNotaEntrada() {
		...
		jcbOrganizar.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo", "Fornecedor"}));
		...
		jbtGerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(7,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Fornecedor"))
					{
						new ControleRelatorio(7,"fornecedor");//gera relatorio por fornecedor
					}
				}
