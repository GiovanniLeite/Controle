...
public class FormRelatorioNotaSaida extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioNotaSaida frame = new FormRelatorioNotaSaida();
	...
	public FormRelatorioNotaSaida() {
		...
		jcbOrganizar.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo", "Cliente"}));
		...
		jbtGerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(8,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Cliente"))
					{
						new ControleRelatorio(8,"cliente");//gera relatorio por cliente
					}
				}
