...
public class FormRelatorioEstado extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioEstado frame = new FormRelatorioEstado();
	...
	public FormRelatorioEstado() {
		...
		jcbOrganizar.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo", "Nome", "Pa\u00EDs"}));
		...
		jbtGerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(4,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Nome"))
					{
						new ControleRelatorio(4,"nome");//gera relatorio por nome
					}
					else if(organizar.equals("País"))
					{
						new ControleRelatorio(4,"pais");//gera relatorio por pais
					}
				}
