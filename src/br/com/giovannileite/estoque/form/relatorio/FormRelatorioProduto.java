...
public class FormRelatorioProduto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioProduto frame = new FormRelatorioProduto();
		...
		jbtGerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(10,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Nome"))
					{
						new ControleRelatorio(10,"nome");//gera relatorio por nome
					}
				}
