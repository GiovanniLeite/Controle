...
public class FormRelatorioCliente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioCliente frame = new FormRelatorioCliente();
	...
	public FormRelatorioCliente() {
		...
		jcbOrganizar.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo", "Nome"}));
		...
		jbtGerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(3,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Nome"))
					{
						new ControleRelatorio(3,"nome");//gera relatorio por nome
					}
				}
		...
		jbtGerar.setBounds(85, 107, 75, 23);
		...
		jbtSair.setBounds(85, 131, 75, 23);
