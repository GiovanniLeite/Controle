...
public class FormRelatorioPais extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioPais frame = new FormRelatorioPais();
		...
		jbtGerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(9,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Nome"))
					{
						new ControleRelatorio(9,"nome");//gera relatorio por nome
					}
