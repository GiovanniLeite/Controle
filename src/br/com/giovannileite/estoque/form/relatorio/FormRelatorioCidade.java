...
public class FormRelatorioCidade extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormRelatorioCidade frame = new FormRelatorioCidade();
	...
	public FormRelatorioCidade() {
		...
		jcbOrganizar.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo", "Nome", "Estado", "Pa\u00EDs"}));
		...
		jbtGerar.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				try
				{
					...
					{
						new ControleRelatorio(2,"codigo");//gera relatorio por codigo
					}
					else if(organizar.equals("Nome"))
					{
						new ControleRelatorio(2,"nome");//gera relatorio por nome
					}
					else if(organizar.equals("Estado"))
					{
						new ControleRelatorio(2,"estado");//gera relatorio por estado
					}
					else if(organizar.equals("País"))
					{
						new ControleRelatorio(2,"pais");//gera relatorio por pais
					}
				}
